...
public class TestPDF {
    ...
    public void document() {
        ...
        Appointment appointment = appointmentService.getAppointmentById(16);

        User user = userService.getById(appointment.getAppointmentPeopleId());

        // 获取体检数据
        Report report = checkItemsDataService.getCheckReportByUser(appointment);
