<template>
  <div style="padding: 10px">
    ...
    <div style="margin: 10px 0">
      <el-button v-if="loginUser.roles[0] === 1 || loginUser.roles[0] === 3" type="primary" @click="add">新增</el-button>
    </div>
    ...
    <el-table v-loading="loading" :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column label="操作">
        <template #default="scope">
          ...
          <el-button v-if="loginUser.roles[0] === 1 || loginUser.roles[0] === 3" size="mini"
            @click="handleEdit(scope.row)">编辑</el-button>
          <el-popconfirm v-if="loginUser.roles[0] === 1 || loginUser.roles[0] === 3" title="确定删除吗？"
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      let isAdmin = this.loginUser.roles.includes(1)
      console.log(isAdmin)
      ...
      if (isAdmin) {
        ...
        console.log('你是医生~~没猜错吧')
        // 是医生
        request.get('/news/byAuthor', {
          params: {
